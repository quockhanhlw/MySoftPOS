package com.example.mysoftpos.ui.main;

import com.example.mysoftpos.R;
import com.example.mysoftpos.ui.txn.PurchaseAmountActivity;
import com.example.mysoftpos.ui.txn.PurchaseCardActivity;
...
public class MainDashboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnSettings).setOnClickListener(v -> {
            Intent intent = new Intent(this, com.example.mysoftpos.config.ConfigDashboardActivity.class);
            startActivity(intent);
        });

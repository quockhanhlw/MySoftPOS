 ...
 * Writes to App-Specific Storage: /Android/data/com.example.mysoftpos/files/iso_logs/
 */
public class FileLogger {
    ...
    public static void logString(Context context, String type, String content) {
        ...
        try {
            ...
            File file = new File(dir, "iso_log_" + dateStr + ".txt");
    ...
    // Executor removed for strict synchronous logging per user request
